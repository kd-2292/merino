...
export class LandingComponent implements OnInit {
  ...
  constructor(private softwareService: SoftwareService, public router: Router , private route: ActivatedRoute , private merinoHelper: MerinohelperService, public meta: Meta, public title: Title) { }
  ...
  ngOnInit() {
        ...
        this.softwareService.getLandingPage(this.countrySlug, this.isLanding ).subscribe(c => {
