...
export class LandingComponent implements OnInit {
  ...
  constructor(private serviceService: ServiceService, public router: Router , private route: ActivatedRoute, private merinoHelper: MerinohelperService, public meta: Meta, public title: Title ) { }
  ...
  ngOnInit() {
        ...
        this.serviceService.getLandingPage(this.countrySlug, this.isLanding ).subscribe(c => {
